...
if (isset($_POST['submit'])) {
	...
	if(!empty($_POST['tag'])){
		foreach($_POST['tag'] as $value){
			$sql = "INSERT INTO products (`Name`, `Price`, `Image`, `Category`,`Tags`,`Shop by price`,`Shop by color`,`Description`) VALUES('".$name."', '".$price."', '".$image."','".$category."', '".$value."', '".$price1."',  '".$color."','".$textfield."')";
            echo $sql;
		}
	}
                        ...
                        <form action="#" method="post">
                            ...
                            <fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                                ...
                                <p>
                                    ...
                                    <select name="price1" class="small-input">
                                        <option >0.0</option>
                                        <option >10.0</option>
                                        <option >20.0</option>
                                        <option >30.0</option>
